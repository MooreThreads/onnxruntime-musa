...
MusaEpProfiler::MusaEpProfiler(const OrtEpApi& api) : OrtEpProfilerImpl{}, ep_api(api) {
...
/*static*/
void ORT_API_CALL MusaEpProfiler::ReleaseImpl(OrtEpProfilerImpl* this_ptr) noexcept {
  delete static_cast<MusaEpProfiler*>(this_ptr);
}

/*static*/
OrtStatus* ORT_API_CALL MusaEpProfiler::StartProfilingImpl(OrtEpProfilerImpl* this_ptr,
...
/*static*/
OrtStatus* ORT_API_CALL MusaEpProfiler::StartEventImpl(OrtEpProfilerImpl* this_ptr,
...
/*static*/
OrtStatus* ORT_API_CALL MusaEpProfiler::StopEventImpl(OrtEpProfilerImpl* this_ptr,
