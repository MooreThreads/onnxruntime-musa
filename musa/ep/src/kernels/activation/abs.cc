...
bool TryMudnnAbs(Ort::KernelContext& ctx, const std::vector<int64_t>& shape,
  ...
  ::musa::dnn::Unary op;
  if (op.SetMode(::musa::dnn::Unary::Mode::ABS) !=
...
ONNX_OPERATOR_VERSIONED_KERNEL_EX(
    Abs, kOnnxDomain, 13, 19,
    (Ort::KernelDefBuilder().AddTypeConstraint("T", AbsTensorTypes())), Abs)
